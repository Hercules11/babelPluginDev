...
const evaluator = (function () {
	...
	const evaluate = (node, scope) => {
		try {
			return astInterpreters[node.type](node, scope); // evaluate is likely a allocator that specify the handler to code block.
		} catch (e) {
			if (
				e &&
				e.message &&
...
globalScope.set("console", {
	...
	}, // think that why Guang made those small mistakes but he can do great work.
	warn: function (...args) {
